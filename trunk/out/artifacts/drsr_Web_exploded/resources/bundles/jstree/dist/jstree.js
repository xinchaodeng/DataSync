        ...
        bind: function () {
            this.element
                ...
                .on("click.jstree", ".jstree-anchor", $.proxy(function (e) {
                    e.preventDefault();
                    if ($(e.currentTarget).closest("div.tree-demo").attr("id") != 'coreMetaTree') {
            ...
            if (!this.is_loaded(obj)) {
                ...
                if (d.length) {
                    if (obj.children.length && !this._firstChild(d.children('.jstree-children')[0])) {
                        ...
                        if ($(d[0]).closest("div.tree-demo").attr("id") != 'coreMetaTree')
                    ...
                    if (!animation) {
                        ...
                        if ($(d[0]).closest("div.tree-demo").attr("id") == 'coreMetaTree')
                            d.children('.jstree-children').removeClass("display-hide");
            ...
            if (d.length) {
                if (!animation) {
                    ...
                    d
                        ...
                        this.style.display = "";
                        d.children('.jstree-children').addClass("display-hide");
